...
abstract class controller                               //controlleur principal qui doit etre herité
{
    ...
    public function render(string $fichier, array $data = [])              //function qui recherche et appelle la vue desirer en fonction du fichier d'entrer
    {
        ...
        public function rendertwo(string $fichier, array $data1 = [], array $data2 = [], array $data3 = [])              //function qui recherche et appelle la vue desirer en fonction du fichier d'entrer
    {
        
        extract($data3);
        extract($data2);
        extract($data1);        //permet de recuperer le nom de la valeur de la variable transmis pour utilisation
