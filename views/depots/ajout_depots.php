...
<form method= post>
    <div> 
        <div class=" card"  style="width:90%; margin:auto;" >
            <div class="card-header"><h2 style="text-align: left;"><b>Effectue un dêpot</b> </h2></div>
            ...
            <div class="card-footer"><h2 style="text-align: left;"><b>Détail dêpot:</b> <i><textarea  rows="5"  type="text" name="notes" value="" ></textarea> </h2></div>
